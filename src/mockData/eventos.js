export default [
    ...
    {
        "name": "Carrera de Velocidad TurboCharge",
        "date": "Domingo, 20 de octubre",
        "description": "Prepárate para la Carrera de Velocidad TurboCharge, presentada por la marca de autos deportivos de élite. Siente la adrenalina mientras los mejores pilotos compiten por la victoria en emocionantes carreras de alta velocidad.",
        "active": true
    },
    {
        "name": "Gala de Moda EleganceStyle",
        "date": "Sábado, 8 de noviembre",
        "description": "La Gala de Moda EleganceStyle te trae lo último en estilo y elegancia. Descubre las tendencias más sofisticadas presentadas por la icónica marca de moda que redefinió el lujo.",
        "active": true
    },
    {
